...
- Ticket 05; create `seen.py`, firstly create `test_seen.py` to check if all ids are fresh in new stored connection (intentionally to fail). Then create `seen.py` to create `SeenStore` creating database connection and table